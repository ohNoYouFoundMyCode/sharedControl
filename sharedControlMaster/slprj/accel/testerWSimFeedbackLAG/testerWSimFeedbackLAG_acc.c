...
#endif
boolean_T testerWSimFeedbackLAG_acc_rt_TDelayUpdateTailOrGrowBuf ( int_T *
...
return ( true ) ; } real_T testerWSimFeedbackLAG_acc_rt_TDelayInterpolate (
...
real_T rtb_B_9_34_0 ; int32_T isHit ; B_testerWSimFeedbackLAG_T * _rtB ;
P_testerWSimFeedbackLAG_T * _rtP ; X_testerWSimFeedbackLAG_T * _rtX ;
DW_testerWSimFeedbackLAG_T * _rtDW ; _rtDW = ( ( DW_testerWSimFeedbackLAG_T *
) ssGetRootDWork ( S ) ) ; _rtX = ( ( X_testerWSimFeedbackLAG_T * )
ssGetContStates ( S ) ) ; _rtP = ( ( P_testerWSimFeedbackLAG_T * )
ssGetModelRtp ( S ) ) ; _rtB = ( ( B_testerWSimFeedbackLAG_T * )
_ssGetModelBlockIO ( S ) ) ; _rtB -> B_9_1_0 = 0.0 ; _rtB -> B_9_1_0 += _rtP
-> P_7 * _rtX -> ZeroPole_CSTATE [ 2 ] ; if ( ( _rtDW -> TimeStampA >= ssGetT
( S ) ) && ( _rtDW -> TimeStampB >= ssGetT ( S ) ) ) { _rtB -> B_9_2_0 = 0.0
; } else { rtb_B_9_34_0 = _rtDW -> TimeStampA ; lastU = & _rtDW ->
LastUAtTimeA ; if ( _rtDW -> TimeStampA < _rtDW -> TimeStampB ) { if ( _rtDW
-> TimeStampB < ssGetT ( S ) ) { rtb_B_9_34_0 = _rtDW -> TimeStampB ; lastU =
...
-> B_9_7_0 = testerWSimFeedbackLAG_acc_rt_TDelayInterpolate ( tMinusDelay ,
0.0 , * tBuffer , * uBuffer , _rtDW -> TransportDelay_IWORK . CircularBufSize
, & _rtDW -> TransportDelay_IWORK . Last , _rtDW -> TransportDelay_IWORK .
Tail , _rtDW -> TransportDelay_IWORK . Head , _rtP -> P_18 , 0 , ( boolean_T
...
_rtB -> B_9_58_0 = _rtP -> P_0 ; } rtb_B_9_34_0 = _rtB -> B_9_4_0 + _rtB ->
B_9_56_0 ; if ( rtb_B_9_34_0 > _rtP -> P_56 ) { _rtB -> B_9_62_0 = _rtP ->
P_56 ; } else if ( rtb_B_9_34_0 < _rtP -> P_57 ) { _rtB -> B_9_62_0 = _rtP ->
P_57 ; } else { _rtB -> B_9_62_0 = rtb_B_9_34_0 ; } rtb_B_9_34_0 = _rtP ->
P_60 * _rtX -> DsLead_CSTATE + _rtP -> P_61 * _rtB -> B_9_62_0 ; if (
rtb_B_9_34_0 > _rtP -> P_62 ) { _rtB -> B_9_64_0 = _rtP -> P_62 ; } else if (
rtb_B_9_34_0 < _rtP -> P_63 ) { _rtB -> B_9_64_0 = _rtP -> P_63 ; } else {
_rtB -> B_9_64_0 = rtb_B_9_34_0 ; } rtb_B_9_34_0 = _rtP -> P_64 * _rtB ->
B_9_64_0 ; _rtB -> B_9_66_0 = _rtB -> B_9_58_0 ; _rtB -> B_9_66_0 .
ActuatorInputs [ 0 ] = _rtB -> B_9_60_0 ; _rtB -> B_9_66_0 . ActuatorInputs [
1 ] = rtb_B_9_34_0 ; _rtB -> B_9_66_0 . ActuatorInputs [ 2 ] = _rtB ->
B_9_60_0 ; _rtB -> B_9_66_0 . ActuatorInputs [ 3 ] = rtb_B_9_34_0 ;
ssCallAccelRunBlock ( S , 7 , 0 , SS_CALL_MDL_OUTPUTS ) ; isHit =
ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { ssCallAccelRunBlock ( S , 9
, 68 , SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 9 , 69 ,
SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 9 , 70 ,
SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 9 , 71 ,
SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 9 , 72 ,
SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 9 , 73 ,
SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 9 , 74 ,
SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 9 , 75 ,
SS_CALL_MDL_OUTPUTS ) ; } _rtB -> B_9_76_0 = _rtB -> B_9_2_0 * _rtB ->
B_9_56_0 ; { real_T * * uBuffer = ( real_T * * ) & _rtDW ->
TransportDelay_PWORK_h . TUbufferPtrs [ 0 ] ; real_T * * tBuffer = ( real_T *
* ) & _rtDW -> TransportDelay_PWORK_h . TUbufferPtrs [ 1 ] ; real_T simTime =
ssGetT ( S ) ; real_T tMinusDelay = simTime - _rtP -> P_65 ; _rtB -> B_9_77_0
= testerWSimFeedbackLAG_acc_rt_TDelayInterpolate ( tMinusDelay , 0.0 , *
...
Tail , _rtDW -> TransportDelay_IWORK_l . Head , _rtP -> P_66 , 0 , (
boolean_T ) ( ssIsMinorTimeStep ( S ) && ( ssGetTimeOfLastOutput ( S ) ==
ssGetT ( S ) ) ) ) ; } UNUSED_PARAMETER ( tid ) ; } static void
mdlOutputsTID2 ( SimStruct * S , int_T tid ) { B_testerWSimFeedbackLAG_T *
_rtB ; P_testerWSimFeedbackLAG_T * _rtP ; _rtP = ( (
P_testerWSimFeedbackLAG_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_testerWSimFeedbackLAG_T * ) _ssGetModelBlockIO ( S ) ) ; _rtB -> B_9_0_0 =
_rtP -> P_4 ; _rtB -> B_9_11_0 = _rtP -> P_22 ; _rtB -> B_9_16_0 = _rtP ->
P_28 ; _rtB -> B_9_17_0 = _rtP -> P_29 ; _rtB -> B_9_27_0 = _rtP -> P_35 ;
_rtB -> B_9_28_0 = _rtP -> P_36 ; _rtB -> B_9_29_0 = _rtP -> P_37 ; _rtB ->
B_9_31_0 = _rtP -> P_38 ; _rtB -> B_9_32_0 = _rtP -> P_39 ; _rtB -> B_9_37_0
= _rtP -> P_41 ; _rtB -> B_9_38_0 = _rtP -> P_42 ; _rtB -> B_9_39_0 = _rtP ->
P_43 ; _rtB -> B_9_40_0 = _rtP -> P_44 ; _rtB -> B_9_43_0 = _rtP -> P_47 ;
_rtB -> B_9_44_0 = _rtP -> P_48 ; _rtB -> B_9_45_0 = _rtP -> P_49 ; _rtB ->
B_9_46_0 = _rtP -> P_50 ; _rtB -> B_9_60_0 = _rtP -> P_55 ; UNUSED_PARAMETER
( tid ) ; }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { real_T * lastU ;
int32_T isHit ; B_testerWSimFeedbackLAG_T * _rtB ; P_testerWSimFeedbackLAG_T
* _rtP ; DW_testerWSimFeedbackLAG_T * _rtDW ; _rtDW = ( (
DW_testerWSimFeedbackLAG_T * ) ssGetRootDWork ( S ) ) ; _rtP = ( (
P_testerWSimFeedbackLAG_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_testerWSimFeedbackLAG_T * ) _ssGetModelBlockIO ( S ) ) ; if ( _rtDW ->
...
B_9_1_0 ; isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { _rtDW ->
DiscreteTimeIntegrator_DSTATE = _rtP -> P_15 * _rtB -> B_9_5_0 + _rtB ->
B_9_6_0 ; } { real_T * * uBuffer = ( real_T * * ) & _rtDW ->
...
. Tail ) { if ( ! testerWSimFeedbackLAG_acc_rt_TDelayUpdateTailOrGrowBuf ( &
...
DiscreteTimeIntegrator_DSTATE_g += _rtP -> P_23 * _rtB -> B_9_76_0 ; _rtDW ->
DiscreteTimeIntegrator1_DSTATE_i += _rtP -> P_25 * _rtB -> B_9_77_0 ; _rtDW
...
testerWSimFeedbackLAG_acc_rt_TDelayUpdateTailOrGrowBuf ( & _rtDW ->
TransportDelay_IWORK_l . CircularBufSize , & _rtDW -> TransportDelay_IWORK_l
. Tail , & _rtDW -> TransportDelay_IWORK_l . Head , & _rtDW ->
TransportDelay_IWORK_l . Last , simTime - _rtP -> P_65 , tBuffer , uBuffer ,
...
B_9_76_0 ; if ( bufferisfull ) { ssSetBlockStateForSolverChangedAtMajorStep (
...
static void mdlDerivatives ( SimStruct * S ) { B_testerWSimFeedbackLAG_T *
_rtB ; P_testerWSimFeedbackLAG_T * _rtP ; X_testerWSimFeedbackLAG_T * _rtX ;
XDot_testerWSimFeedbackLAG_T * _rtXdot ; _rtXdot = ( (
XDot_testerWSimFeedbackLAG_T * ) ssGetdX ( S ) ) ; _rtX = ( (
X_testerWSimFeedbackLAG_T * ) ssGetContStates ( S ) ) ; _rtP = ( (
P_testerWSimFeedbackLAG_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_testerWSimFeedbackLAG_T * ) _ssGetModelBlockIO ( S ) ) ; _rtXdot ->
...
_rtB -> B_9_64_0 ; _rtXdot -> DsLead_CSTATE = 0.0 ; _rtXdot -> DsLead_CSTATE
+= _rtP -> P_58 * _rtX -> DsLead_CSTATE ; _rtXdot -> DsLead_CSTATE += _rtP ->
P_59 * _rtB -> B_9_62_0 ; } static void mdlInitializeSizes ( SimStruct * S )
{ ssSetChecksumVal ( S , 0 , 2972496883U ) ; ssSetChecksumVal ( S , 1 ,
4067692547U ) ; ssSetChecksumVal ( S , 2 , 1896019109U ) ; ssSetChecksumVal (
S , 3 , 564329492U ) ; { mxArray * slVerStructMat = NULL ; mxArray * slStrMat
...
DW_testerWSimFeedbackLAG_T ) ) { ssSetErrorStatus ( S ,
"Unexpected error: Internal DWork sizes do "
"not match for accelerator mex file." ) ; } if ( ssGetSizeofGlobalBlockIO ( S
) != sizeof ( B_testerWSimFeedbackLAG_T ) ) { ssSetErrorStatus ( S ,
"Unexpected error: Internal BlockIO sizes do "
"not match for accelerator mex file." ) ; } { int ssSizeofParams ;
ssGetSizeofParams ( S , & ssSizeofParams ) ; if ( ssSizeofParams != sizeof (
P_testerWSimFeedbackLAG_T ) ) { static char msg [ 256 ] ; sprintf ( msg ,
"Unexpected error: Internal Parameters sizes do "
"not match for accelerator mex file." ) ; } } _ssSetModelRtp ( S , ( real_T *
) & testerWSimFeedbackLAG_rtDefaultP ) ; rt_InitInfAndNaN ( sizeof ( real_T )
