...
#ifndef RTW_HEADER_testerWSimFeedback_acc_private_h_
#define RTW_HEADER_testerWSimFeedback_acc_private_h_
#include "rtwtypes.h"
...
; real_T testerWSimFeedback_acc_rt_TDelayInterpolate ( real_T tMinusDelay ,
