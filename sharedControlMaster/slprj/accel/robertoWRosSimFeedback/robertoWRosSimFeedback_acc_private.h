...
#ifndef RTW_HEADER_robertoWRosSimFeedback_acc_private_h_
#define RTW_HEADER_robertoWRosSimFeedback_acc_private_h_
#include "rtwtypes.h"
...
; real_T robertoWRosSimFeedback_acc_rt_TDelayInterpolate ( real_T tMinusDelay
