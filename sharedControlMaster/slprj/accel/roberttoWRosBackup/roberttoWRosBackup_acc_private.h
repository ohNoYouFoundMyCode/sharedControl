...
#ifndef RTW_HEADER_roberttoWRosBackup_acc_private_h_
#define RTW_HEADER_roberttoWRosBackup_acc_private_h_
#include "rtwtypes.h"
...
; real_T roberttoWRosBackup_acc_rt_TDelayInterpolate ( real_T tMinusDelay ,
